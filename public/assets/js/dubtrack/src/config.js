	...
	helpers : {
		...
		text : {
			convertHtmltoTags: function(text, imagloadFun){
				var imageRegex = /^((http|https)\:\/\/(i\.imgur\.com|img[0-9]{2}\.deviantart\.net|media[0-9]?\.giphy\.com|[0-9]{2}\.media\.tumblr\.com|s-media-cache-ak[0-9]\.pinimg\.com|reactiongifs\.com))(.*)\.(png|jpg|jpeg|gif)$/;
